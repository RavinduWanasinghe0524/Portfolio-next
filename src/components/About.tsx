    ...
    <section id="about" style={{ padding: "5rem 0" }}>
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 1.5rem" }}>
        ...
        <div className="bento-grid">
          ...
          <div
            className="glass glow-border mouse-glow card-hover reveal-left bento-span-2"
          ...
          {/* Repos stat */}
          <div
            className="glass glow-border mouse-glow card-hover reveal"
            onMouseMove={onMouseMove}
            ...
            <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: 8 }}>
              {[
                ...
                <li key={t} style={{ display: "flex", alignItems: "center", gap: 8, fontSize: "0.875rem", color: "#cbd5e1" }}>
                  <span style={{ color: c, fontSize: "0.7rem" }}>▸</span> {t}
                </li>
              ))}
            </ul>
          </div>
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, fontFamily: "var(--font-geist-mono)", fontSize: "0.72rem" }}>
              {[
          ...
          <div
            className="glass glow-border mouse-glow card-hover reveal-right bento-span-2"
            onMouseMove={onMouseMove}
            style={{ padding: "1.75rem" }}
          >
            <div style={{ width: 44, height: 44, borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.25rem", background: "rgba(37,99,235,0.15)", marginBottom: "1rem" }}>🎓</div>
            <div style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-start", justifyContent: "space-between", gap: "0.75rem", marginBottom: "0.75rem" }}>
              ...
              <span style={{
                fontSize: "0.7rem", fontWeight: 700, padding: "0.3rem 0.75rem", borderRadius: 99,
                background: "rgba(37,99,235,0.1)", border: "1px solid rgba(59,130,246,0.25)",
                color: "#93c5fd", fontFamily: "var(--font-geist-mono)", whiteSpace: "nowrap",
              }}>2024 – 2028</span>
            </div>
